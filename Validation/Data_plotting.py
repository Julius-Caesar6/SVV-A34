...
# ax = plt.axes(projection='3d')
# # ax.set_aspect('equal')
# ax.scatter(Jam_Straight_stress_R1['intpointx'], Jam_Straight_stress_R1['intpointy'], Jam_Straight_stress_R1['intpointz'], color = cm.brg(Jam_Straight_stress_R1['S.Mises.mean']))
# ax.scatter(Jam_Straight_stress_R2['intpointx'], Jam_Straight_stress_R2['intpointy'], Jam_Straight_stress_R2['intpointz'], color = cm.brg(Jam_Straight_stress_R2['S.Mises.mean']))
# ax.legend()
# ax.set_xlabel('$x$')
# ax.set_ylabel('$y$')
# ax.set_zlabel('$z$')
